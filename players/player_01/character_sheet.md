...
* Name: Quarterstaff (Two-Weapons)
* Type: Melee
* Reach / Range increments (fts.): 5, 5
* Attack Bonus: -9, -9
* Damage: 1d6-1
* Critical: 20 / 2x, 20 / 2x
* Damage Type: Bludgeon, Bludgeon
* Special: double, monk
* Ammo type / Amount (Empty if none):

* Name: Quarterstaff (One Head)
* Type: Melee
...
List trained skills (or usable untrained).
...
# Death & Resurrection Log (If Applicable)

Track mechanical and narrative impact.
