...
> Current status: Tiers 1, 1.1, 1.5, 1.6, 1.7, 1.8, and 1.10 (partial) complete. Tiers 1.9 and 1.10.5 (PC combat actions) in progress. Tier 1.9 complete. Tier 1.10.5 next. Then 1.11 (death/dying).
