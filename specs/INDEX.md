...
| [llm-providers.feature](llm-providers.feature) | Backend \| Frontend | `@llm` `@groq` `@ollama` `@provider` | 4 | Groq API, Ollama API, `Header.tsx` model dropdown |
...
| [session-controls.feature](session-controls.feature) | Frontend | `@header` `@boot` `@provider` `@controls` | 6 | `Header.tsx`, provider toggle, model dropdown |
...
**Total: 80 acceptance criteria across 15 feature files**
